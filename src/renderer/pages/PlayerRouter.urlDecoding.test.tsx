...
describe('PlayerRouter URL Decoding', () => {
  ...
  it('should decode URL-encoded video ID with colons', async () => {
    ...
    expect(mockElectron.getVideoData).toHaveBeenCalledWith(expectedDecodedId);
  });
  ...
  it('should handle simple YouTube video IDs without issues', async () => {
    ...
    expect(mockElectron.getVideoData).toHaveBeenCalledWith(youtubeVideoId);
  });
  ...
  it('should handle double-encoded video IDs correctly', async () => {
    ...
    const expectedDecodedId = 'local%3A%2Fhome%2Fuser%2FVideos%2FTest%20Video.mp4';
